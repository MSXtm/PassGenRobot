...
async def inline(query: types.InlineQuery):
    results = [
        types.InlineQueryResultArticle(
            id="1",
            title="رمز دیوانه وار | بسیار قدرتمند",
            description="دو پسوند، دو پیشوند، سه کلمه، جداسازی با حروف تصادفی",
        ...
        types.InlineQueryResultArticle(
            id="2",
            title="رمز خیلی قوی",
            description="چهار کلمه، جداسازی با اعداد تصادفی، حروف بزرگ تصادفی",
            input_message_content=types.InputTextMessageContent(
        ...
        types.InlineQueryResultArticle(
            id="3",
            title="رمز قوی",
            description="سه کلمه، جداسازی با اعداد تصادفی، حروف بزرگ تصادفی",
            input_message_content=types.InputTextMessageContent(
        ...
        types.InlineQueryResultArticle(
            id="4",
            title="رمز معمولی",
            description="سه کلمه، بدون جداسازی کلمات، کلمه میانی با حروف بزرگ",
            input_message_content=types.InputTextMessageContent(
        ...
        types.InlineQueryResultArticle(
            id="5",
            title="رمز ضعیف",
            description="دو کلمه، بدون جداسازی کلمات",
            input_message_content=types.InputTextMessageContent(
